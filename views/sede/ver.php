...
<body class="bg-background-light dark:bg-background-dark text-slate-800 dark:text-slate-200 transition-colors duration-300 antialiased font-display h-screen overflow-hidden flex">
    ...
    <aside class="w-64 h-full bg-surface-light dark:bg-surface-dark border-r border-slate-200 dark:border-slate-700 flex flex-col shrink-0 transition-colors duration-300">
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-3 space-y-1">
            ...
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-slate-600 dark:text-slate-400 rounded-lg hover:bg-sena-green/10 hover:text-sena-green transition-colors">
                <ion-icon src="../../assets/ionicons/grid-outline.svg" class="text-[20px]"></ion-icon>
                Dashboard
            </a>
            ...
            <a href="index.php" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium bg-sena-green/10 text-sena-green rounded-lg transition-colors">
                <ion-icon src="../../assets/ionicons/business-outline.svg" class="text-[20px]"></ion-icon>
                Sedes
            </a>
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-slate-600 dark:text-slate-400 rounded-lg hover:bg-sena-green/10 hover:text-sena-green transition-colors">
                <ion-icon src="../../assets/ionicons/school-outline.svg" class="text-[20px]"></ion-icon>
                Programas
            </a>
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-slate-600 dark:text-slate-400 rounded-lg hover:bg-sena-green/10 hover:text-sena-green transition-colors">
                <ion-icon src="../../assets/ionicons/people-outline.svg" class="text-[20px]"></ion-icon>
                Instructores
            </a>
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-slate-600 dark:text-slate-400 rounded-lg hover:bg-sena-green/10 hover:text-sena-green transition-colors">
                <ion-icon src="../../assets/ionicons/calendar-outline.svg" class="text-[20px]"></ion-icon>
                Horarios
            </a>

            <p class="px-3 text-xs font-semibold text-slate-400 uppercase tracking-wider mt-6 mb-2">Configuración</p>
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-slate-600 dark:text-slate-400 rounded-lg hover:bg-sena-green/10 hover:text-sena-green transition-colors">
                <ion-icon src="../../assets/ionicons/settings-outline.svg" class="text-[20px]"></ion-icon>
                Ajustes
            </a>
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-slate-600 dark:text-slate-400 rounded-lg hover:bg-sena-green/10 hover:text-sena-green transition-colors">
                <ion-icon src="../../assets/ionicons/help-circle-outline.svg" class="text-[20px]"></ion-icon>
                Ayuda
            </a>
        </nav>
        ...
        <div class="p-4 border-t border-slate-100 dark:border-slate-800">
            <a href="#" class="flex items-center gap-3 w-full hover:bg-slate-50 dark:hover:bg-slate-800 p-2 rounded-lg transition-colors group">
                ...
                <ion-icon src="../../assets/ionicons/log-out-outline.svg" class="text-slate-400 group-hover:text-sena-green"></ion-icon>
            </a>
        </div>
    </aside>
    ...
    <div id="successOverlay" class="fixed inset-0 z-[60] hidden flex items-center justify-center pointer-events-none">
        <div class="bg-sena-green text-white px-6 py-3 rounded-full shadow-xl flex items-center gap-3 animate-bounce">
            <ion-icon src="../../assets/ionicons/checkmark-circle-outline.svg" class="text-2xl"></ion-icon>
            <span class="font-bold">Sede eliminada correctamente</span>
        </div>
    </div>
