                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-slate-800 dark:text-white font-medium">Detalle de Programa</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div class="p-8 max-w-7xl mx-auto space-y-6">
        ...
        <div id="programaDetails" class="space-y-6" style="display: none;">
                    ...
                    <div class="bg-surface-light dark:bg-surface-dark rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
                        <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center">
                            <h3 class="font-bold text-slate-900 dark:text-white flex items-center gap-2">
                                <ion-icon src="../../assets/ionicons/book-outline.svg" class="text-slate-400"></ion-icon>
                        ...
                        <div class="p-6">
                            ...
                            <div id="noCompetencias" class="text-center py-12">
                                <ion-icon src="../../assets/ionicons/book-outline.svg" class="text-slate-200 text-5xl mb-3"></ion-icon>
            ...
            <div class="flex justify-end pt-4">
                <button id="deleteProgramaBtn" class="flex items-center gap-2 bg-white dark:bg-slate-800 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 px-4 py-3 rounded-xl shadow-md border border-red-100 dark:border-red-900/30 transition-all duration-300 hover:translate-y-[-2px] active:translate-y-[0px] group">
