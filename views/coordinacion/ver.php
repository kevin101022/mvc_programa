...
<main class="main-content">
    <header class="main-header">
        <div class="header-content">
            <nav class="breadcrumb">
                ...
                <span>Detalle de Coordinación</span>
            </nav>
            <h1 class="page-title">Información de Coordinación</h1>
        </div>
    ...
    <div class="content-wrapper">
        <div id="loadingState" class="bg-white rounded-xl shadow-sm p-12 text-center">
            ...
            <p class="text-gray-500">Cargando coordinación...</p>
        </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
                    <div class="bg-gray-50 h-24 flex items-center justify-center border-b border-gray-50">
                        <ion-icon src="../../assets/ionicons/people-circle-outline.svg" class="text-gray-200 text-6xl"></ion-icon>
                    </div>
                    <div class="p-6 text-center">
                        <p class="text-[10px] font-extrabold text-gray-400 uppercase tracking-[0.2em] mb-1">COORDINACIÓN ACADÉMICA</p>
                        <h2 class="text-xl font-black text-sena-green mb-1" id="detCoordNombre">--</h2>
                        <p class="text-xs text-gray-500 mb-6 font-medium" id="detCentroPertenece">Centro de Formación</p>
        ...
        <div id="errorState" class="bg-white rounded-xl shadow-sm p-12 text-center" style="display: none;">
            ...
            <p id="errorMessage" class="text-gray-500">No encontramos la coordinación que buscas.</p>
        </div>
    </div>
</main>
